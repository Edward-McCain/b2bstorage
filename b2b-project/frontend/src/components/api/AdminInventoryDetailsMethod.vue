<template>
  <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-3">
          <div class="flex items-center space-x-2">
            ...
            <span class="text-sm font-mono text-gray-600">/admin/inventories/{id}</span>
          </div>
        </div>
        <div class="flex items-center space-x-2">
    ...
    <div class="p-6 space-y-6">
      <!-- Description -->
      <div>
        <h3 class="text-lg font-medium text-gray-900 mb-2">Детали инвентаризации</h3>
        <p class="text-gray-600">
          Получение подробной информации об инвентаризации включая все позиции, файлы и связанные данные. 
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr>
                ...
                <td class="px-4 py-3 text-sm text-gray-600">ID инвентаризации</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div>
        ...
        <div class="space-y-3">
          ...
          <div class="bg-red-50 rounded-lg p-4">
            ...
            <p class="text-sm text-red-700 mb-2">Инвентаризация не найдена</p>
      ...
      <div>
        ...
        <div class="space-y-4">
          <div class="bg-blue-50 rounded-lg p-4">
            <h5 class="text-sm font-medium text-blue-900 mb-2">Получение деталей инвентаризации</h5>
            <pre class="text-sm text-blue-800 overflow-x-auto"><code>{{ getInventoryDetailsExample }}</code></pre>
          </div>
        </div>
      </div>
    </div>
...
export default {
  name: 'AdminInventoryDetailsMethod',
  components: {
    Send,
    CheckCircle,
    AlertCircle,
  ...
  "data": {
    ...
    "total_actual": 148500.00,
    "difference": -1500.00,
    "currency": "UZS",
    "notes": "Годовая инвентаризация склада",
    ...
    "items": [
      {
        ...
        "actual_price": 45000.00,
        "expected_total": 450000.00,
        "actual_total": 405000.00,
        "difference_amount": -45000.00,
        "currency": "UZS"
      }
    ],
    "files": [
      {
        "id": 1,
        "filename": "inventory_2024_001.pdf",
        "original_name": "inventory_report.pdf",
        "size": 307200,
        "mime_type": "application/pdf",
        "url": "/storage/inventories/inventory_2024_001.pdf",
        "created_at": "2024-01-15T10:30:00Z"
      }
    ]
  }
  ...
  "error": "Инвентаризация не найдена"
      ...
      getInventoryDetailsExample: `GET /api/admin/inventories/1
