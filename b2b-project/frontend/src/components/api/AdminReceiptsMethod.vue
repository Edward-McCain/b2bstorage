<template>
  <div class="bg-white rounded-lg shadow-sm p-6 lg:p-8">
    ...
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center space-x-3">
        <div class="flex items-center space-x-2">
          ...
          <span class="font-mono text-lg text-gray-900">/admin/receipts</span>
        </div>
      </div>
      <div class="flex items-center space-x-2">
    ...
    <!-- Title -->
    <div class="mb-8">
      <h1 class="text-lg lg:text-xl font-semibold text-gray-900">Список оприходований (админ)</h1>
    </div>

    <!-- Description -->
    <div class="mb-8">
      <p class="text-gray-700 leading-relaxed">
        Получает список всех оприходований в системе с расширенной информацией для администраторов. Включает данные о создателях, поставщиках, товарах и финансовую статистику.
      </p>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Поиск по номеру, поставщику или товарам</td>
            </tr>
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Фильтр по создателю оприходования</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Включить статистику по оприходованиям</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export default {
  ...
  "data": [
    {
      ...
      "currency": "RUB",
      "notes": "Оприходование электроники",
      ...
      "files": [
        {
          "id": 1,
          "name": "invoice.pdf",
          "url": "https://example.com/files/invoice_1.pdf",
          "size": 1024000
        }
      ]
    },
    {
      ...
      "currency": "RUB",
      "notes": "Оприходование канцелярии",
  ...
  "stats": {
    "total_receipts": 1250,
    "confirmed_receipts": 1180,
    "draft_receipts": 45,
    "cancelled_receipts": 25,
    "total_amount": 156789000.00,
    "avg_amount": 125431.20,
    "total_items": 5670
  }
}`,
      curlExample: `curl -X GET "https://api.example.com/api/admin/receipts?page=1&per_page=15&status=confirmed&date_from=2024-01-01&date_to=2024-01-31&include_stats=true" \\
