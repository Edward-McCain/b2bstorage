<template>
  <div class="bg-white rounded-lg shadow-sm p-6 lg:p-8">
    ...
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center space-x-3">
        <div class="flex items-center space-x-2">
          ...
          <span class="font-mono text-lg text-gray-900">/admin/users/{id}</span>
        </div>
      </div>
      <div class="flex items-center space-x-2">
    ...
    <!-- Title -->
    <div class="mb-8">
      <h1 class="text-lg lg:text-xl font-semibold text-gray-900">Детали пользователя</h1>
    </div>

    <!-- Description -->
    <div class="mb-8">
      <p class="text-gray-700 leading-relaxed">
        Получает подробную информацию о конкретном пользователе системы. Этот метод доступен только администраторам и предоставляет полную информацию о пользователе, включая статистику активности и настройки.
      </p>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">ID пользователя</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Включить статистику активности</td>
            </tr>
            <tr>
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">include_settings</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">boolean</td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <span class="px-2 py-1 bg-gray-100 text-gray-800 rounded-full text-xs">Нет</span>
              </td>
              <td class="px-6 py-4 text-sm text-gray-500">Включить настройки пользователя</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export default {
  ...
  "data": {
    ...
    "profile": {
      ...
      "position": "Менеджер",
      "department": "Продажи",
      "bio": "Опытный менеджер по продажам с 5-летним стажем",
    ...
    "activity": {
      "total_logins": 45,
      "last_activity": "2024-01-20T14:25:00.000000Z",
      "created_products": 12,
      "created_receipts": 8,
      "created_write_offs": 3,
      "created_inventories": 2,
      "total_orders": 156,
    ...
    "subscription": {
      ...
      curlExample: `curl -X GET "https://api.example.com/api/admin/users/1?include_activity=true&include_settings=true" \\
