<template>
  <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-3">
          <div class="flex items-center space-x-2">
            ...
            <span class="text-sm font-mono text-gray-600">/admin/write-offs/{id}</span>
          </div>
        </div>
        <div class="flex items-center space-x-2">
    ...
    <div class="p-6 space-y-6">
      <!-- Description -->
      <div>
        <h3 class="text-lg font-medium text-gray-900 mb-2">Детали списания</h3>
        <p class="text-gray-600">
          Получение подробной информации о списании включая все позиции, файлы и связанные данные. 
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr>
                ...
                <td class="px-4 py-3 text-sm text-gray-600">ID списания</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div>
        ...
        <div class="space-y-3">
          ...
          <div class="bg-red-50 rounded-lg p-4">
            ...
            <p class="text-sm text-red-700 mb-2">Списание не найдено</p>
      ...
      <div>
        ...
        <div class="space-y-4">
          <div class="bg-blue-50 rounded-lg p-4">
            <h5 class="text-sm font-medium text-blue-900 mb-2">Получение деталей списания</h5>
            <pre class="text-sm text-blue-800 overflow-x-auto"><code>{{ getWriteOffDetailsExample }}</code></pre>
          </div>
        </div>
      </div>
    </div>
...
export default {
  name: 'AdminWriteOffDetailsMethod',
  components: {
    Send,
    CheckCircle,
    AlertCircle,
  ...
  "data": {
    ...
    "files": [
      {
        "id": 1,
        "filename": "write_off_2024_001.pdf",
        "original_name": "damage_report.pdf",
        "size": 184320,
        "mime_type": "application/pdf",
        "url": "/storage/write-offs/write_off_2024_001.pdf",
        "created_at": "2024-01-15T10:30:00Z"
      }
    ]
  }
  ...
  "error": "Списание не найдено"
      ...
      getWriteOffDetailsExample: `GET /api/admin/write-offs/1
