<template>
  <div class="bg-white rounded-lg shadow-sm p-6 lg:p-8">
    ...
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center space-x-3">
        <div class="flex items-center space-x-2">
          ...
          <span class="font-mono text-lg text-gray-900">/admin/write-offs</span>
        </div>
      </div>
      <div class="flex items-center space-x-2">
    ...
    <!-- Title -->
    <div class="mb-8">
      <h1 class="text-lg lg:text-xl font-semibold text-gray-900">Список списаний (админ)</h1>
    </div>

    <!-- Description -->
    <div class="mb-8">
      <p class="text-gray-700 leading-relaxed">
        Получает список всех списаний в системе с расширенной информацией для администраторов. Включает данные о создателях, причинах списания, товарах и финансовую статистику.
      </p>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Поиск по номеру, причине или товарам</td>
            </tr>
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Фильтр по создателю списания</td>
            </tr>
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Фильтр по складу</td>
            </tr>
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Фильтр по статусу: draft, confirmed, cancelled</td>
            </tr>
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Фильтр по причине: damage, expiration, loss, other</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Сортировка: created_at, updated_at, total_amount, number</td>
            </tr>
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Включить статистику по списаниям</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export default {
  ...
  "data": [
    {
      ...
      "date": "2024-01-20",
      "reason": "damage",
      "reason_text": "Повреждение при транспортировке",
      "warehouse_id": 1,
      "warehouse": {
        "id": 1,
        "name": "Основной склад",
      ...
      "currency": "RUB",
      "notes": "Списание поврежденных товаров",
      ...
      "files": [
        {
          ...
          "url": "https://example.com/files/damage_report_1.pdf",
          "size": 512000
        }
      ]
    },
    {
      ...
      "date": "2024-01-19",
      "reason": "expiration",
      "reason_text": "Истек срок годности",
      "warehouse_id": 2,
      "warehouse": {
        "id": 2,
        "name": "Склад №2",
        "address": "г. Санкт-Петербург, ул. Другая, д. 5"
      },
      "user_id": 2,
      "user": {
        "id": 2,
      ...
      "currency": "RUB",
      "notes": "Списание просроченных товаров",
      "created_at": "2024-01-19T14:15:00.000000Z",
      "updated_at": "2024-01-19T14:15:00.000000Z",
      "positions": [
        {
          "id": 2,
          "product_id": 3,
  ...
  "stats": {
    "total_write_offs": 450,
    "confirmed_write_offs": 420,
    "draft_write_offs": 20,
    "cancelled_write_offs": 10,
    ...
    "by_reason": {
      ...
      curlExample: `curl -X GET "https://api.example.com/api/admin/write-offs?page=1&per_page=15&status=confirmed&reason=damage&date_from=2024-01-01&date_to=2024-01-31&include_stats=true" \\
