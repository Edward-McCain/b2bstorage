  ...
  <div class="bg-white rounded-lg shadow-sm p-6 lg:p-8">
    ...
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center space-x-3">
        <div class="flex items-center space-x-2">
          ...
          <span class="font-mono text-lg text-gray-900">/balances</span>
        </div>
        <h1 class="text-xl lg:text-2xl font-bold text-gray-900">Создание остатка</h1>
      </div>
      <div class="flex items-center space-x-2">
    ...
    <div class="mb-8">
      <p class="text-gray-700 leading-relaxed">
        Создает новый остаток товара в системе. Позволяет добавить информацию о количестве товара на конкретном складе.
      </p>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
              ...
              <td class="px-6 py-4 text-sm text-gray-500">Количество товара</td>
            </tr>
            <tr>
    ...
    <div class="mb-8">
      ...
      <div class="space-y-4">
        ...
        <div class="border border-red-200 rounded-lg p-4 bg-red-50">
          ...
          <p class="text-sm text-red-700">
            Остаток для данного товара на указанном складе уже существует.
          </p>
        </div>
        <div class="border border-red-200 rounded-lg p-4 bg-red-50">
          <div class="flex items-center justify-between mb-2">
...
export default {
  ...
  "message": "Остаток успешно создан"
}`,
      curlExample: `curl -X POST "https://api.example.com/api/balances" \\
