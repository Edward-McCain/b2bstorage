<template>
  <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
    <div class="flex items-center gap-3 mb-4">
      ...
      <div>
        <h3 class="text-lg font-semibold text-gray-900">GET /balances/out-of-stock</h3>
        <p class="text-sm text-gray-600">Товары с нулевым остатком</p>
      </div>
    </div>
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <p class="text-gray-700 text-sm">
          Возвращает список товаров, у которых остаток равен нулю. Используется для контроля отсутствия товаров на складах.
        </p>
      </div>
      ...
      <div>
        ...
        <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
          <pre class="text-green-400 text-sm"><code>GET /api/balances/out-of-stock?warehouse_id=1&category_id=5
