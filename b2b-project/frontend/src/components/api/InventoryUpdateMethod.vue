  ...
  <div class="bg-white rounded-lg shadow-sm p-6 lg:p-8">
    ...
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center space-x-3">
        ...
        <div>
          ...
          <h1 class="text-lg lg:text-xl font-bold text-gray-900 mt-1">Обновление инвентаризации</h1>
        </div>
      </div>
      <button
        @click="copyEndpoint"
    ...
    <div class="mb-6">
      ...
      <p class="text-sm lg:text-base text-gray-600 leading-relaxed">
        Обновляет существующую инвентаризацию. Можно изменить дату, склад, описание и примечания. 
        Обновление возможно только для инвентаризаций в статусе "draft".
      </p>
    </div>
      ...
      <div class="bg-gray-50 rounded-lg p-4">
        <div class="space-y-3">
          ...
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
              <span class="text-sm text-gray-600">Статус (draft, in_progress)</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
      ...
      <div class="bg-gray-50 rounded-lg p-4">
        <div class="space-y-3">
          ...
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
              <span class="text-sm text-gray-600">Обновленная инвентаризация</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
          ...
          <div class="flex items-start space-x-3">
            <span class="text-sm font-medium text-gray-700 min-w-24">status</span>
            <div class="flex-1">
              <span class="text-sm text-gray-600">Статус инвентаризации</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
            <span class="text-sm font-medium text-gray-700 min-w-24">warehouse</span>
            <div class="flex-1">
              <span class="text-sm text-gray-600">Обновленная информация о складе</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center space-x-3 p-3 bg-red-50 rounded-lg">
          ...
          <div>
            ...
            <div class="text-sm text-red-600">Инвентаризация не может быть изменена</div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      curlExample: `curl -X PUT "https://api.example.com/api/inventories/1" \\
  ...
  -d '{
    "date": "2024-01-16",
    "warehouse_id": 1,
    "description": "Обновленная годовая инвентаризация",
    "status": "in_progress",
    "notes": "Инвентаризация в процессе"
  }'`,
      responseExample: `{
  "success": true,
  "data": {
  ...
  methods: {
    async copyEndpoint() {
      const endpoint = 'PUT /api/inventories/{id}'
      try {
