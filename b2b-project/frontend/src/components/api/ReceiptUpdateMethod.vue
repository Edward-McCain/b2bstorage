  ...
  <div class="bg-white rounded-lg shadow-sm p-6 lg:p-8">
    ...
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center space-x-3">
        <div class="bg-yellow-100 p-2 rounded-lg">
          <Receipt class="h-5 w-5 text-yellow-600" />
        </div>
        <div>
          ...
          <h1 class="text-lg lg:text-xl font-bold text-gray-900 mt-1">Обновление оприходования</h1>
        </div>
      </div>
      <button
        @click="copyEndpoint"
    ...
    <div class="mb-6">
      ...
      <p class="text-sm lg:text-base text-gray-600 leading-relaxed">
        Обновляет существующее оприходование. Можно изменить дату, поставщика, склад, позиции товаров и примечания. 
        Обновление возможно только для оприходований в статусе "draft".
      </p>
    </div>
      ...
      <div class="bg-gray-50 rounded-lg p-4">
        <div class="space-y-3">
          ...
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
              <span class="text-sm text-gray-600">ID поставщика</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
      ...
      <div class="bg-gray-50 rounded-lg p-4">
        <div class="space-y-3">
          ...
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
              <span class="text-sm text-gray-600">Обновленное оприходование</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
          ...
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
              <span class="text-sm text-gray-600">Статус оприходования</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center space-x-3 p-3 bg-red-50 rounded-lg">
          ...
          <div>
            ...
            <div class="text-sm text-red-600">Оприходование не может быть изменено</div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      curlExample: `curl -X PUT "https://api.example.com/api/receipts/1" \\
  ...
  -d '{
    ...
    "notes": "Обновленное оприходование товаров"
  }'`,
      responseExample: `{
  "success": true,
  "data": {
  ...
  methods: {
    async copyEndpoint() {
      const endpoint = 'PUT /api/receipts/{id}'
      try {
