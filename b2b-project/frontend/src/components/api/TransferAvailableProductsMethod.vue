<template>
  <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
    <div class="flex items-center gap-3 mb-4">
      ...
      <div>
        <h3 class="text-lg font-semibold text-gray-900">POST /transfers/available-products</h3>
        <p class="text-sm text-gray-600">Получение доступных товаров для перемещения</p>
      </div>
    </div>
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <p class="text-gray-700 text-sm">
          Возвращает список товаров, доступных для перемещения с указанного склада, с информацией о количестве на складе.
        </p>
      </div>
        ...
        <div class="bg-gray-50 rounded-lg p-4">
          <div class="space-y-2 text-sm">
            ...
            <div class="flex justify-between">
              ...
              <span class="text-gray-600">Минимальное количество на складе</span>
            </div>
            <div class="flex justify-between">
      ...
      <div>
        ...
        <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
          <pre class="text-green-400 text-sm"><code>POST /api/transfers/available-products
...
Body:
{
  ...
  "links": {
    "first": "http://api.example.com/transfers/available-products?page=1",
    "last": "http://api.example.com/transfers/available-products?page=3",
    "prev": null,
    "next": "http://api.example.com/transfers/available-products?page=2"
  },
  "meta": {
    "current_page": 1,
    "from": 1,
      ...
      <div>
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="text-sm text-gray-700">Not Found - Склад не найден</span>
          </div>
        </div>
      </div>
    </div>
