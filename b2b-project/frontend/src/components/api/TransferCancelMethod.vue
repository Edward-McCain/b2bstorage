<template>
  <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
    <div class="flex items-center gap-3 mb-4">
      ...
      <div>
        <h3 class="text-lg font-semibold text-gray-900">POST /transfers/{id}/cancel</h3>
        <p class="text-sm text-gray-600">Отмена перемещения</p>
      </div>
    </div>
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <p class="text-gray-700 text-sm">
          Отменяет перемещение товаров. Доступно для черновиков и подтвержденных перемещений. При отмене подтвержденного перемещения товары возвращаются в доступные на складе отправления.
        </p>
      </div>
        ...
        <div class="bg-gray-50 rounded-lg p-4">
          <div class="space-y-2 text-sm">
            ...
            <div class="flex justify-between">
              ...
              <span class="text-gray-600">Причина отмены (optional)</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
          <pre class="text-green-400 text-sm"><code>POST /api/transfers/1/cancel
...
Body:
{
  "reason": "Изменение планов по перемещению товаров"
}</code></pre>
        </div>
      </div>
  ...
  "data": {
    ...
    "cancellation_reason": "Изменение планов по перемещению товаров",
    "created_at": "2024-01-20T09:15:00Z",
    "updated_at": "2024-01-20T18:00:00Z",
    "cancelled_at": "2024-01-20T18:00:00Z"
  },
  "message": "Перемещение успешно отменено"
}</code></pre>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="text-sm text-gray-700">Conflict - Невозможно отменить завершенное перемещение</span>
          </div>
        </div>
      </div>
    </div>
