  ...
  <div class="bg-white rounded-lg shadow-sm p-6 lg:p-8">
    ...
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center space-x-3">
        ...
        <div>
          ...
          <h1 class="text-lg lg:text-xl font-bold text-gray-900 mt-1">Получение списания по ID</h1>
        </div>
      </div>
      <button
        @click="copyEndpoint"
    ...
    <div class="mb-6">
      ...
      <p class="text-sm lg:text-base text-gray-600 leading-relaxed">
        Возвращает детальную информацию о списании по его уникальному идентификатору. 
      ...
      <div class="bg-gray-50 rounded-lg p-4">
        <div class="space-y-3">
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
              <span class="text-sm text-gray-600">Уникальный идентификатор списания</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
          ...
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
              <span class="text-sm text-gray-600">Дата списания</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
          ...
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
              <span class="text-sm text-gray-600">Общая сумма списания</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
            <span class="text-sm font-medium text-gray-700 min-w-24">currency</span>
            <div class="flex-1">
              <span class="text-sm text-gray-600">Валюта списания</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center space-x-3 p-3 bg-red-50 rounded-lg">
          ...
          <div>
            ...
            <div class="text-sm text-red-600">Нет доступа к данному списанию</div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      curlExample: `curl -X GET "https://api.example.com/api/write-offs/1" \\
  ...
  methods: {
    async copyEndpoint() {
      const endpoint = 'GET /api/write-offs/{id}'
      try {
