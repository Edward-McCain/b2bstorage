  ...
  <div class="bg-white rounded-lg shadow-sm p-6 lg:p-8">
      ...
      <div class="flex items-center space-x-3">
        ...
        <div>
          <div class="flex items-center space-x-2">
            ...
            <span class="font-mono text-sm lg:text-base text-gray-900">/write-off-files/{writeOffId}</span>
          </div>
          <h1 class="text-lg lg:text-xl font-bold text-gray-900 mt-1">Получение файлов списания</h1>
        </div>
      </div>
      <button
        @click="copyEndpoint"
    ...
    <div class="mb-6">
      ...
      <p class="text-sm lg:text-base text-gray-600 leading-relaxed">
        Возвращает список всех файлов, прикрепленных к конкретному списанию. 
        Включает информацию о размере, типе файла и URL для скачивания.
      </p>
    </div>
      ...
      <div class="bg-gray-50 rounded-lg p-4">
        <div class="space-y-3">
          <div class="flex items-start space-x-3">
            <span class="text-sm font-medium text-gray-700 min-w-20">writeOffId</span>
            <div class="flex-1">
              <span class="text-sm text-gray-600">ID списания (обязательно)</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="bg-gray-50 rounded-lg p-4">
        <div class="space-y-3">
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
              <span class="text-sm text-gray-600">Массив файлов списания</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
          ...
          <div class="flex items-start space-x-3">
            <span class="text-sm font-medium text-gray-700 min-w-24">write_off_id</span>
            <div class="flex-1">
              <span class="text-sm text-gray-600">ID списания</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
...
export default {
  ...
  data() {
    return {
      curlExample: `curl -X GET "https://api.example.com/api/write-off-files/1" \\
  ...
  "data": [
    {
      ...
      "url": "https://example.com/files/damage_report.pdf",
      "size": 512000,
      "type": "application/pdf",
      "description": "Акт о порче товара",
    ...
    },
    {
      ...
      "size": 256000,
      "type": "image/jpeg",
      "description": "Фото испорченного товара",
    ...
    },
    {
      ...
      "url": "https://example.com/files/inventory_report.xlsx",
      "size": 128000,
      "type": "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      "description": "Отчет по инвентаризации",
  ...
  methods: {
    async copyEndpoint() {
      const endpoint = 'GET /api/write-off-files/{writeOffId}'
      try {
