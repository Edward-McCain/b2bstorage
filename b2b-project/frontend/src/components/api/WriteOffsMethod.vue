  ...
  <div class="bg-white rounded-lg shadow-sm p-6 lg:p-8">
    ...
    <div class="flex items-center justify-between mb-6">
      <div class="flex items-center space-x-3">
        ...
        <div>
          ...
          <h1 class="text-lg lg:text-xl font-bold text-gray-900 mt-1">Получение списка списаний</h1>
        </div>
      </div>
      <button
        @click="copyEndpoint"
    ...
    <div class="mb-6">
      ...
      <p class="text-sm lg:text-base text-gray-600 leading-relaxed">
        Возвращает список всех списаний пользователя с возможностью фильтрации и пагинации. 
      ...
      <div class="bg-gray-50 rounded-lg p-4">
        <div class="space-y-3">
          <div class="flex items-start space-x-3">
            ...
            <div class="flex-1">
              <span class="text-sm text-gray-600">Массив списаний</span>
            </div>
          </div>
          <div class="flex items-start space-x-3">
...
export default {
  ...
  data() {
    return {
      curlExample: `curl -X GET "https://api.example.com/api/write-offs?page=1&per_page=15&status=approved" \\
  ...
  methods: {
    async copyEndpoint() {
      const endpoint = 'GET /api/write-offs'
      try {
