...
// Тест импорта продуктов без категорий

$baseUrl = 'http://127.0.0.1:8000/api';
$token = '104|wsMyBT4ZTLUkbZJHMspCRUPyXgRdHtsOHQOgRtdY01939b73';

echo "Тестирование импорта продуктов без категорий...\n";
...
if ($httpCode === 200) {
    echo "✅ УСПЕХ: Импорт продуктов без категорий работает корректно!\n";
