...
// Тест отладки API уведомлений

class NotificationsApiDebugTest {
    private $baseUrl = 'http://localhost:8000/api';
    
    public function runTests() {
        echo "\n🔍 ОТЛАДКА API УВЕДОМЛЕНИЙ\n";
        echo "============================\n\n";
        
        // Тест 1: Проверка без фильтров
        $this->testNoFilters();
        
        // Тест 2: Проверка с фильтром по типу
        $this->testTypeFilter();
        
        // Тест 3: Проверка с фильтром по статусу
        $this->testReadStatusFilter();
        
        // Тест 4: Проверка комбинированных фильтров
...
// Запуск тестов
$test = new NotificationsApiDebugTest();
$test->runTests();
