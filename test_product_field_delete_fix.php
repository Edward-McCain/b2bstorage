<?php
/**
 * Тест исправления удаления кастомных полей
 * Запуск: php test_product_field_delete_fix.php
 */
...
class ProductFieldDeleteFixTester {
    private $baseUrl;
    private $token;
    ...
    public function testProductFieldDeleteFix() {
        echo "🔍 ТЕСТ ИСПРАВЛЕНИЯ УДАЛЕНИЯ КАСТОМНЫХ ПОЛЕЙ\n";
        echo "==============================================\n\n";
...
// Запуск теста
$tester = new ProductFieldDeleteFixTester($baseUrl, $token);
$tester->testProductFieldDeleteFix(); 